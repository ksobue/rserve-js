...
const constants = {
    ...
    IS_OOB_SEND             : function(x) { return (x & 0x0ffff000) === constants.OOB_SEND; },
    IS_OOB_MSG              : function(x) { return (x & 0x0ffff000) === constants.OOB_MSG; },
    ...
    HAS_ATTR                : function(x) { return (x & constants.XT_HAS_ATTR) > 0; },
    IS_LARGE                : function(x) { return (x & constants.XT_LARGE) > 0; }
};
